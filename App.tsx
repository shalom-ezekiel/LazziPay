...
const App: React.FC = () => {
  ...
  const renderView = () => {
    switch (currentView) {
      ...
      case AppView.DASHBOARD:
        return <Dashboard plan={settings.selectedPlan} />;
      case AppView.SETTINGS:
        return <Settings settings={settings} setSettings={setSettings} />;
      case AppView.LOGIN:
        return (
          <Login 
            onSwitchToSignup={() => setCurrentView(AppView.SIGNUP)} 
            onLogin={() => setCurrentView(AppView.DASHBOARD)}
      ...
      case AppView.SIGNUP:
        return (
          <Signup 
            ...
            onSignup={() => setCurrentView(AppView.DASHBOARD)}
            onBackToHome={navigateToLanding}
  ...
  return (
    <div className="min-h-screen flex flex-col selection:bg-blue-100 selection:text-blue-900 bg-slate-50 transition-colors">
      {!isAuthView && !isDashboardView && <Header currentView={currentView} setView={setCurrentView} />}
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
              <div className="lg:col-span-2">
                ...
                <p className="text-slate-500 max-w-sm mb-8 leading-relaxed">
                  LazziPay – Where insight and confidence meet intelligence, empowering businesses to detect, understand, and resolve friction before trust breaks.
                </p>
                <div className="flex gap-4">
                  <button onClick={() => setCurrentView(AppView.SIGNUP)} className="bg-blue-600 text-white px-6 py-2.5 rounded-xl font-bold text-sm hover:bg-blue-700 transition">Try for Free</button>
                  <button onClick={() => setCurrentView(AppView.DEMO)} className="bg-slate-800 text-white px-6 py-2.5 rounded-xl font-bold text-sm hover:bg-slate-700 transition">Book a Demo</button>
                </div>
              </div>
            ...
            <div className="pt-12 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-6">
              <p className="text-xs text-slate-600 font-medium">
                ...
                <a href="#" className="hover:text-white transition">Privacy Policy</a> <span className="mx-2">|</span> 
